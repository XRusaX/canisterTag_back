...
public class SpringGwtRemoteServiceServlet extends RemoteServiceServlet {
	...
	public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
		...
		threadLocalRequest.setRequest((HttpServletRequest) request);
		super.service(request, response);
	}

	@Override
	public void init() {
		log("Spring GWT service exporter deployed");
	}
	...
	public String processCall(String payload) throws SerializationException {
		try {
			...
			// System.out.println("Invoking " + handler.getClass().getName() +
	...
	protected Object getBean(HttpServletRequest request) {
		...
		// System.out.println("Bean for service " + service + " is " + bean);
		return bean;
	}
	...
	protected String getService(HttpServletRequest request) {
		...
		// System.out.println("Service for URL " + url + " is " + service);
		return service;
	}
